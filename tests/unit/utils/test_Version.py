...
from sgraph_ai.utils.Version                            import version__sgraph_ai, Version
...
class test_Version(TestCase):
    ...
    def test_path_code_root(self):
        assert self.version.path_code_root() == sgraph_ai.path
    ...
    def test_value(self):
        assert self.version.value() == version__sgraph_ai
